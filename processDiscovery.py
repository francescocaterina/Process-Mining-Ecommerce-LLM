...
# Inserisci la tua chiave Groq qui
...
@st.cache_resource
def process_data():
    # Caricamento log (Fase: Preprocess Dataset) [cite: 10, 12]
    ...
    # ALGORITMO 1: ALPHA MINER [cite: 15]
    ...
    # ALGORITMO 2: HEURISTIC MINER [cite: 15]
    ...
    # ALGORITMO 3: INDUCTIVE MINER [cite: 15]
...
# --- 4. CHATBOT PER REASONING [cite: 19, 27] ---
st.divider()
