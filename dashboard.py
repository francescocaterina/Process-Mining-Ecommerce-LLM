...
# --- 1. CONFIGURAZIONE ---
# Assicurati che Graphviz sia installato per visualizzare i modelli [cite: 16]
...
def process_data():
    ...
    # Funzione per calcolare le 4 metriche di qualità [cite: 17]
...
# --- 4. NUOVA SEZIONE: PREDICTION (Slide 24 & 28) ---
st.divider()
...
# --- 5. REASONING & ANOMALIES (Slide 21, 22, 29) ---
st.divider()
